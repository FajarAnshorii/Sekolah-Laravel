...
@section('content')
    ...
    <div class="portal-form-block">
        ...
        <!-- FORM -->
        <form action="{{ route('portal-mahasiswa.sertifikat.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-4">
                    ...
                    <input type="text" name="nama_sertifikat" id="nama_sertifikat" class="form-control @error('nama_sertifikat') is-invalid @enderror" placeholder="Masukkan nama sertifikat..." value="{{ old('nama_sertifikat') }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group mb-4">
                    ...
                    <select name="jenis" id="jenis" class="form-control @error('jenis') is-invalid @enderror" required>
                        ...
                        <option value="Sertifikasi Profesi" {{ old('jenis') == 'Sertifikasi Profesi' ? 'selected' : '' }}>Sertifikasi Profesi</option>
                    </select>
                    @error('jenis')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                ...
                <div class="col-md-4 form-group mb-4">
                    ...
                    <input type="number" name="jumlah_jam" id="jumlah_jam" class="form-control @error('jumlah_jam') is-invalid @enderror" placeholder="Contoh: 32" value="{{ old('jumlah_jam') }}" min="1" required>
                    @error('jumlah_jam')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-4">
                    ...
                    <small class="text-muted d-block mt-1"><i class="fas fa-info-circle mr-1"></i>Format: <strong>PDF, JPG, JPEG, PNG</strong> (Maksimal 5 MB)</small>
            ...
            <div class="form-group mb-4">
                ...
                <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Tuliskan keterangan detail mengenai kompetensi atau topik pelatihan..." rows="4">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
