    ...
    <div class="portal-form-block">
        ...
        <div class="portal-form-header">
            <h3 class="portal-form-title">
                ...
                <span>Edit Penghargaan</span>
            </h3>
            <a href="{{ route('portal-mahasiswa.penghargaan.index') }}" class="btn-portal-back">
                <i class="fas fa-arrow-left"></i> Kembali
            </a>
        </div>

        <!-- FORM -->
        <form action="{{ route('portal-mahasiswa.penghargaan.update', $penghargaan->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-4">
                    <label for="nama_penghargaan">Nama Penghargaan <span class="required">*</span></label>
                    <input type="text" name="nama_penghargaan" id="nama_penghargaan" class="form-control @error('nama_penghargaan') is-invalid @enderror" value="{{ old('nama_penghargaan', $penghargaan->nama_penghargaan) }}" required>
                ...
                <div class="col-md-6 form-group mb-4">
                    ...
                    <input type="text" name="penyelenggara" id="penyelenggara" class="form-control @error('penyelenggara') is-invalid @enderror" value="{{ old('penyelenggara', $penghargaan->penyelenggara) }}" required>
                    @error('penyelenggara')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row">
                <!-- TINGKAT -->
                <div class="col-md-6 form-group mb-4">
                    <label for="tingkat">Tingkat Penghargaan <span class="required">*</span></label>
                ...
                <!-- TANGGAL -->
                <div class="col-md-6 form-group mb-4">
                    <label for="tanggal">Tanggal Diperoleh <span class="required">*</span></label>
                    <input type="date" name="tanggal" id="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $penghargaan->tanggal) }}" required>
                    @error('tanggal')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group mb-4">
                ...
                @if($penghargaan->file_sertifikat)
                    <div class="current-file-box">
                        ...
                        <span><strong>File saat ini:</strong> <a href="{{ asset('storage/files/prestasi/' . $penghargaan->file_sertifikat) }}" target="_blank" download style="color: var(--primary); font-weight: 600; text-decoration: underline;">{{ $penghargaan->file_sertifikat }}</a></span>
                    </div>
                @endif
            ...
            <div class="form-group mb-4">
                ...
                <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="4">{{ old('deskripsi', $penghargaan->deskripsi) }}</textarea>
                @error('deskripsi')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-actions-footer">
                ...
                <a href="{{ route('portal-mahasiswa.penghargaan.index') }}" class="btn-portal-cancel">
