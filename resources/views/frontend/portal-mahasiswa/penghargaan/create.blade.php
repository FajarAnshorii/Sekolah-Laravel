...
@section('content')
    ...
    <div class="portal-form-block">
        ...
        <!-- FORM -->
        <form action="{{ route('portal-mahasiswa.penghargaan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-4">
                    ...
                    <input type="text" name="nama_penghargaan" id="nama_penghargaan" class="form-control @error('nama_penghargaan') is-invalid @enderror" placeholder="Masukkan nama penghargaan..." value="{{ old('nama_penghargaan') }}" required>
            ...
            <div class="form-group mb-4">
                <label for="file_sertifikat">File Sertifikat <span class="required">*</span></label>
                <div class="custom-file">
                    <input type="file" name="file_sertifikat" id="file_sertifikat" class="custom-file-input @error('file_sertifikat') is-invalid @enderror" required>
                    <label class="custom-file-label" for="file_sertifikat">Pilih file sertifikat...</label>
                </div>
                <small class="text-muted d-block mt-1"><i class="fas fa-info-circle mr-1"></i>Format yang diizinkan: <strong>PDF, JPG, JPEG, PNG</strong> (Maksimal 5 MB)</small>
            ...
            <div class="form-group mb-4">
                ...
                <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Tuliskan keterangan detail mengenai penghargaan yang diperoleh..." rows="4">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
