...
@section('title', 'Tambah Perlombaan')
...
@section('content')
    ...
    <div class="portal-form-block">
        ...
        <!-- FORM -->
        <form action="{{ route('portal-mahasiswa.perlombaan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-4">
                    ...
                    <input type="text" name="nama_perlombaan" id="nama_perlombaan" class="form-control @error('nama_perlombaan') is-invalid @enderror" placeholder="Masukkan nama perlombaan..." value="{{ old('nama_perlombaan') }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group mb-4">
                    ...
                    <input type="text" name="juara" id="juara" class="form-control @error('juara') is-invalid @enderror" placeholder="Contoh: Juara 1 / Harapan 2..." value="{{ old('juara') }}" required>
                    @error('juara')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-group mb-4">
                <label for="file_sertifikat">File Sertifikat / Bukti Menang <span class="required">*</span></label>
            ...
            <div class="form-group mb-4">
                ...
                <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Tuliskan keterangan tambahan mengenai kejuaraan yang diraih..." rows="4">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
