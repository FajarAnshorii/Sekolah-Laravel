                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-statistics">
                            <div class="card-header">
                                <h4 class="card-title">Statistik Website</h4>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">1397</h4>
                                    ...
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">577</h4>
                                    ...
                                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                        <div class="media">
                                            ...
                                            <div class="media-body my-auto">
                                                <h4 class="font-weight-bolder mb-0">377</h4>
