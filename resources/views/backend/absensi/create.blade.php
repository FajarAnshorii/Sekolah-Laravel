    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Input Absensi</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-body">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><i data-feather="sliders" class="mr-50"></i>Pilih Kelas & Tanggal</h4>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ route('backend-absensi.create') }}">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-4 col-12">
                            <button type="submit" class="btn btn-primary">
                                <i data-feather="search" class="mr-50"></i>Tampilkan Siswa
                            </button>
                        </div>
                    </div>
                </form>
        ...
        @if ($selected_kelas && $mahasiswa->count() > 0)
        {{-- Notif jika sudah ada data absensi --}}
        @if($existing->count() > 0)
        <div class="alert alert-warning">
            <div class="alert-body">
                <i data-feather="alert-triangle" class="mr-50"></i>
                <strong>Perhatian:</strong> Absensi untuk kelas <strong>{{ $selected_kelas }}</strong> tanggal <strong>{{ \Carbon\Carbon::parse($selected_tanggal)->translatedFormat('d F Y') }}</strong> sudah pernah diinput. Data akan <strong>diperbarui</strong>.
            </div>
        </div>
        @endif

        {{-- Form Input Absensi --}}
        <form action="{{ route('backend-absensi.store') }}" method="POST" id="form-absensi">
            @csrf
            ...
            <div class="card">
                ...
                <div class="card-body py-1 border-bottom bg-light-primary">
                    <div class="row text-center">
                        ...
                        <div class="col">
                            ...
                            <small class="d-block text-muted">Tidak Hadir</small>
                        </div>
                        <div class="col">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                    <a href="{{ route('backend-absensi.index') }}" class="btn btn-outline-secondary">
                        <i data-feather="arrow-left" class="mr-50"></i>Kembali
                    </a>
        ...
        @elseif($selected_kelas && $mahasiswa->count() == 0)
        <div class="alert alert-info">
            <div class="alert-body">
                <i data-feather="info" class="mr-50"></i>
                Tidak ada mahasiswa aktif di kelas <strong>{{ $selected_kelas }}</strong>.
            </div>
        </div>
        @endif
